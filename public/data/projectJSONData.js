export default {
  ...
  frustration: {
    image: '../images/frustrationScreenshot.png',
    description:
      "Just like my personal website you're on right now, Frustration was written in pure JavaScript, HTML, and CSS. It works on both desktop and mobile (if mobile is detected, the ways to flip the cards change to be touch-friendly). It's a fun riff on the classic Memory/Concentration card game where flipping the cards is a little harder and a timer is ticking down. This app was fun for me to utilize some JavaScript basics and see how far I can push the basic DOM manipulation.",
    demoLink: 'https://frustration.netlify.com',
    codeLink: 'https://www.github.com/frustration-memory-card-game'
  },
  mtg: {
  ...
  blackjack: {
    ...
    description:
      "This was a quick practice project to make sure my fundamental coding skills were still sharp. I tried to focus on sticking with functional programming strictly and used only NodeJS. It's console blackjack! After making it, I was surprised to learn that I actually have a lot of fun with it.",
    codeLink: 'https://github.com/cbrand125/blackjack-fp'
  }
};
